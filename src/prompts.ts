...
export async function chooseDependencyAction(provided?: DependencyAction): Promise<DependencyAction> {
  if (provided) {
    return provided;
  }
...
export async function promptDependencySearchQuery(provided?: string): Promise<string> {
  if (provided?.trim()) {
