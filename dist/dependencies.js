...
export function parseDependencySearchQuery(rawQuery) {
...
export function dependencyEntryMatches(query, entry) {
...
export async function searchDependencyInArchive(options) {
    const result = await runRemoteTextCommand(options.client, options.target, buildListArchiveEntriesCommand(options.archivePath), 60000);
